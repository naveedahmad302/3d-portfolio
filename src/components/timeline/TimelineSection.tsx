  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-primary/30 border-2 border-primary items-center justify-center z-10"
      >
    ...
    <section id="experience" className="section-padding relative" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative">
          <div className="hidden md:block absolute left-1/2 -translate-x-px top-0 bottom-0 w-[2px] bg-gradient-to-b from-primary/30 via-accent/20 to-transparent" />
